...
const HeroSection = () => {
  ...
  return (
    <motion.section
      className="relative min-h-screen flex items-center overflow-hidden dotted-bg"
        ...
        <div className="flex-1 flex flex-col gap-4 md:gap-6">
          <AnimatePresence mode="wait">
            ...
            >
              <Typography
                variant="label"
                className="uppercase tracking-widest text-sm font-bold mb-2 opacity-80 px-3 py-2 rounded-md bg-black"
