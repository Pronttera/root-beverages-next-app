      ...
      <Section className="dotted-bg bg-white mt-16 md:mt-10">
        <div className="max-w-4xl mx-auto">
          ...
          <Typography variant="body">
            Welcome to Root Beverages ("we", "us", or "our"). These Terms of
            Service ("Terms") govern your access to and use of our website
            https://rootbeverages.asia ("Website") and any related services
          ...
          <Typography variant="body">
            ...
            images, and software — is the property of Root Beverages and is
          ...
          <Typography variant="body">
            To the fullest extent permitted by law, Root Beverages shall not be
          ...
          <Typography variant="body">
            ...
            applicable laws. Any disputes shall be subject to the exclusive
